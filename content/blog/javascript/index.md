...
* `rest` operator gives you rest of input arguments as array.
	* should always occur at end of the list
...
* Interesting JS topics mentioned, like e.g. *event delegation*:
